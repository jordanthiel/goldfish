...
import { Calendar } from '@goldfish/shared/components/ui/calendar';
...
import { Avatar, AvatarFallback, AvatarImage } from '@goldfish/shared/components/ui/avatar';
...
const ClientDetails = () => {
  ...
  const sortedAppointments = [...(clientData.appointmentsList || [])].sort((a, b) => 
                      ...
                      <TabsContent value="appointments" className="space-y-6">
                        <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
                          <Card>
                            ...
                            <CardContent>
                              {clientData.appointmentsList && clientData.appointmentsList.length > 0 ? (
                                <div className="space-y-4">
